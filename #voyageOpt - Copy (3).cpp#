		...
		for (int i1 = 0; i1 < model.weather[ii].nFiles; i1++) {
			...
			for (int i10 = 0; i10 < model.params.nHindCastMonths; i10++) {
				if (model.params.hindCast_month[i10] < 10)
					sprintf(namn, "%s/weather/hindcast/%d/%s_0%d_%d.grb", model.params.indataPath.c_str(), model.params.hindCast_year[i10],
						model.weather[ii].filePos[i1].fileName, model.params.hindCast_month[i10],
						model.params.hindCast_year[i10]);
				else
					sprintf(namn, "%s/weather/hindcast/%d/%s_%d_%d.grb", model.params.indataPath.c_str(), model.params.hindCast_year[i10],
						model.weather[ii].filePos[i1].fileName, model.params.hindCast_month[i10],
						model.params.hindCast_year[i10]);
				printf("%s\n", namn);
